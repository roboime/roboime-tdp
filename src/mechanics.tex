\section{Mechanical Project}\label{mec_sec}
...
Manufacturing) a new robot has been developed. Figures \ref{mec} shows mechanical
...
\begin{figure}[thpb]
	\centering
	\includegraphics[width = .8 \textwidth]{img/cad.jpg}
	\caption{Mechanical 3D model view.}\label{mec_a}
	\includegraphics[width = .8 \textwidth]{img/robo.jpeg}
	\caption{Robot view.}\label{mec_b}
\end{figure}
